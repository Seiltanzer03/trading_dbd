...
REFINEMENT_VERSION = "seiltanzer-storage-refinement-v1"
...
def create_backup_honest_encryption(self, *, kind: str = "local", reason: str = "scheduled"):
    ...
    if kind == "offhost":
        encrypted = os.environ.get("SEILTANZER_OFFHOST_ENCRYPTION_VERIFIED", "").lower() in {"1", "true", "yes"}
        manifest["encryption_status"] = "verified_external_target" if encrypted else "external_target_not_verified"
