"""Бесплатный WebSocket-стрим цен инструмента и option-proxy (Yahoo Finance).
...
Мы подписываемся на тикеры инструментов/proxy и держим свежую цену в памяти; фид
...
Только цены инструмента/proxy стримятся бесплатно — опционные цепочки/плотность
по-прежнему приходят delayed REST-снимками (тиковые опционы требуют провайдера).
"""
