...
def install_g1_short_horizon_routes(app: FastAPI) -> None:
    ...
    app.add_api_route(
        "/api/research/g1s/status", runtime.status,
        methods=["GET"], name="g1s_status")
    app.add_api_route(
        "/api/research/g1s/horizons",
        lambda: {"contract_version": runtime.status()["contract_version"],
                 "items": [runtime.horizon_report(h) for h in runtime.status()["primary_horizons"]
                           + [120, 240]]},
    ...
    app.add_api_route(
        "/api/research/g1s/oos", runtime.prospective_oos,
        methods=["GET"], name="g1s_oos")
    app.add_api_route(
        "/api/research/g1s/ablation", runtime.ablation,
        methods=["GET"], name="g1s_ablation")
    app.add_api_route(
        "/api/research/g1s/trade-relevance", runtime.trade_relevance,
        methods=["GET"], name="g1s_trade_relevance")
    app.add_api_route(
        "/api/research/g1/q/audit", runtime.q_audit,
    ...
    app.add_api_route(
        "/api/research/g1/management/local-edge", local.edge,
        methods=["GET"], name="g1m_local_edge")
    app.add_api_route(
        "/api/research/g1/management/local-status", local.status,
        methods=["GET"], name="g1m_local_status")
    app.add_api_route(
        "/api/research/runtime/materializers", runtime.materializer_status,
    ...
    app.add_api_route(
        "/api/research/runtime/status", runtime_status,
