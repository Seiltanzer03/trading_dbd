...
Нельзя менять числа, CVaR-feasible set или расчётную политику. Но расчётная политика
и разрешённое к исполнению действие — разные сущности: при manual_data_conflict или
...
Запрещены размытые объяснения «выше потенциальная прибыль», «слишком раннее
действие» и «лучший risk-adjusted» без числового сравнения. Для полного EXIT при
низкой надёжности первая строка обязана начинаться с запрета исполнения, а не с
приказа закрыть позицию."""
