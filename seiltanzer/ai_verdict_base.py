...
Ответ 320–520 слов, строго с разделами:
ДЕЙСТВИЕ — дословно action_ru.
ГЕОМЕТРИЯ СДЕЛКИ — exact CURRENT/ENTRY/original STOP/active risk barrier/TAKE,
текущий R, расстояния в R и фактический остаток из position_state.
TAKE vs STOP/BE — только authoritative execution-MC, отдельно от Q и P shadow.
